export class Navegacion_HogaryMuebles_Jardin{
    ...
    Jardin_Card(){return cy.get(this.Class_Card_Jardin,{timeout:4000}).contains(this.Txt_Card_Jardin);}
    Title_Jardin_AireLibre(){return cy.get(this.Class_Title_Seccion_Jardin,{timeout:3000}).contains(this.Txt_Title)};
};